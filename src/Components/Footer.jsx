    ...
    <div className="row">
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">+91 8210016650</a>
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">akanagni123@gmail.com</a>
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">Noida-UP, INDIA</a>
          <p className="contact-box__info--subtitle">Akanksha Agnihotri, India</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="container">
      <div className="row py-4 text-center text-white">
        ...
        <div className="col-lg-7 col-md-6">
          ...
          <a href="https://github.com/dkrvission88" target="_blank"><i className="fab fa-github"></i></a>
          <a href="https://linkedin.com/in/dheeraj-kumar55" target="_blank"><i className="fab fa-linkedin"></i></a>
          <a href="https://www.twitter.com" target='_blank'><i className="fab fa-instagram"></i></a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div className="row text-center text-white">
        <div className="col-12">
          <div className="footer-bottom__copyright">
            &COPY; Copyright 2024 <a href="#">Company</a> | Created by <a href="http://codewithpatrick.com" target="_blank">Akanksha</a><br/><br/>

            Distributed by <a href="http://themewagon.com" target="_blank">Agnihotri</a>
          </div>
        </div>
      </div>
    </div>
